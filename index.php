...
<body>
        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                      <li><a href="index.pho" class="active">Principal</a></li>
  ...
  <?php
    ...
    $consulta = "SELECT * FROM `products` WHERE `status-promocion` = 1 ORDER BY `posicion`";
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="caption header-text">
            <h6>Divina Belleza</h6>
            <h2>¡Mira nuestro Producto del Mes!</h2>
            <p></p>
            <div class="search-input">
              <form id="search" action="shop.php">
        ...
        <div class="col-lg-4 offset-lg-2">
          <div class="right-image">
            <img src="assets/images/products/LANEIGE.png" alt="">
            <span class="price">COP22.000</span>
    ...
    <div class="container">
      <div class="row">
        ...
        <!-- <div class="col-lg-3 col-md-6">
          <div class="item">
            <div class="thumb">
              <a href="product-details.html"><img src="assets/images/products/LumiGlotion.png" alt=""></a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <div class="section-heading">
            <h6>Categorias</h6>
            <h2>Explora entre nuestros tipos de Productos</h2>
          </div>
        </div>
        <div class="col-lg col-sm-6 col-xs-12">
          <div class="item">
            <h4>Facial</h4>
            <div class="thumb">
              <a href="shop.html"><img src="assets/images/cara.png" alt=""></a>
            </div>
          </div>
        </div>
        <div class="col-lg col-sm-6 col-xs-12">
          <div class="item">
            <h4>Uñas</h4>
            <div class="thumb">
              <a href="shop.html"><img src="assets/images/unas.png" alt=""></a>
            </div>
          </div>
        </div>
        <div class="col-lg col-sm-6 col-xs-12">
          <div class="item">
            <h4>Labios</h4>
            <div class="thumb">
              <a href="shop.html"><img src="assets/images/labios.png" alt=""></a>
            </div>
          </div>
        </div>
        <div class="col-lg col-sm-6 col-xs-12">
          <div class="item">
            <h4>Pelo</h4>
            <div class="thumb">
              <a href="shop.html"><img src="assets/images/pelo.png" alt=""></a>
            </div>
          </div>
        </div>
        <div class="col-lg col-sm-6 col-xs-12">
          <div class="item">
            <h4>Ojos</h4>
            <div class="thumb">
              <a href="shop.html"><img src="assets/images/ojos.png" alt=""></a>
            </div>
          </div>
        </div>
      </div>
